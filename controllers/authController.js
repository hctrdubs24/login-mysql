...
exports.updatePassword = async (req, res) => {
  try {
    const newPassword = req.body.newPass,
      ...
      PasswordUtilizada = req.session.password;
    ...
    if (newPassword === confirmNewPassword) {
      if (oldPassword === confirmNewPassword) {
        ...
        if (PasswordUtilizada == oldPassword) {
          ...
          res.render("password", {
            alert: true,
            alertTitle: "Error",
            alertMessage: "Confirme la contraseña actual de la cuenta",
            alertIcon: "Error",
            showConfirmButton: true,
            timer: false,
            ruta: "password",
...
exports.createUser = async (req, res) => {
  ...
  if (
    ...
    model.validateUserName(req, res, data, "new");
  }
};
...
exports.updateUser = async (req, res) => {
  ...
  if (
    ...
    model.validateUserName(req, res, data, "edit");
  }
};
